...
describe('parseComments', () => {
  ...
  it('should throw error passed an object with no key of name',
    () => expect(() => parseComments([{ comment: '' }])).toThrowError());
  it('should turn a array of comments into AST objects containing info about the comment',
    () => expect(parseComments([{ comment: '* this is a description', name: 'test' }]))
      .toEqual([{ description: 'this is a description', name: 'test', tags: [] }]));
  it('should turn a array of comments with tags into AST objects containing info about the comment including and array of tags', () => expect(parseComments([{ comment: '* this is a description \n * @param { String } param', name: 'test' }])).toEqual([{
  ...
  it('should add any tags of description to the description key of the object', () => expect(parseComments([{ comment: '* this is a description \n * @description some more description', name: 'test' }])).toEqual([{
